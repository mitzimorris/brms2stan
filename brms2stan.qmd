...
The posterior predictive coverage test indicates that the simpler model provides better predictive accuracy;
given the small number of subjects and observations in this study, this makes a lot of sense.
...
Plugging the `log_lik` values into `loo_compare`, loo also reports that the simpler model is better calibrated for the data.
